...
public class ParkingServiceTest {
    ...
    public void createTest() {
        ParkingForm form = new ParkingForm("Teste", "123454856", "12348899", "Rua Joao da Costa 2",
    ...
    @Test
    public void getById() {
        ParkingForm form = new ParkingForm("Nome Teste", "123456", "12345879", "Rua Joao da Costa",
    ...
    public void disableById() {
        ParkingForm form = new ParkingForm("Nome Teste Novamente", "1234569888", "12345678", "Rua Joao da Costa",
                "321", "Sao Paulo", "SP", "Jardim Cruz", "", "12", "4234234");
    ...
    @Test
    public void update() {
        ParkingForm form = new ParkingForm("Nome htrhrt", "12345665464", "12345678", "Rua Joao da Costa",
